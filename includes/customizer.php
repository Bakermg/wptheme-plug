...
/*******************************************
  ...
  $textcolors[] = array(
		'slug' => 'wpmu_color3',
		'default' => '#ffffff',
		'label' => __( 'Background color', 'wpmu' )
	);
...
function wpmu_add_color_scheme() {
  ...
  $color_scheme4 = get_option( 'wpmu_color4' );
...
body {
  background-color: <?php echo $color_scheme3; ?>;
  color: <?php echo $color_scheme4; ?>;
}
